...
class MainScreen : Fragment() {
    ...
    override fun onCreateView(
        ...
        val title = view.findViewById<EditText>(R.id.movietitle)
        val gearBTN = view.findViewById<ImageButton>(R.id.gear)
        searchBTN.setOnClickListener{
            var name = title.text.toString()
            viewModel.selectTitle(name)
        }
        gearBTN.setOnClickListener {
            var intent : Intent = Intent(Intent.ACTION_SENDTO, Uri.fromParts(
                "mailto", "shargent152@gmail.com", null))
